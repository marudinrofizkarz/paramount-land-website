...
import {
  ...
  ZoomIn,
  Download,
  MessageCircle, // Tambahkan icon untuk WhatsApp
} from "lucide-react";
...
import { use } from "react"; // Tambahkan impor use dari React

// Tambahkan fungsi untuk menghilangkan tag HTML
...
export default function UnitDetailPage({
  ...
  const { slug, unitSlug } = unwrappedParams;
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Ambil data unit berdasarkan slug proyek dan slug unit
        const unitResponse = await getUnitBySlug(slug, unitSlug);

        // Ambil daftar proyek untuk header
              ...
              <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                <DialogContent className="max-w-7xl w-full h-[90vh] p-0 bg-black/95 border-none">
                  ...
                  <div className="relative w-full h-full flex items-center justify-center">
                    {/* Hapus DialogClose button manual ini */}
