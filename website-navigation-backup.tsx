...
import { ChevronDownIcon, ChevronRightIcon } fr              <div
                className={`
                grid gap-6 p-6 overflow-visible
                ${
                  isMobile
                    ? "grid-cols-1"
              ...
              <div
                ...
                ${
                  isMobile
                    ...
                    : "top-full left-0 right-0 w-auto min-w-max mx-auto max-w-6xl mt-2 desktop-mega-menu"
                }
                ${
                  isActive
